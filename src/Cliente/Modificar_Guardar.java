...
if(VistaAdmin.BanderaGuardarActualizarCliente){
    controlador.guardar(Integer.parseInt(jtflNIT.getText().trim()),jtflNombre.getText().trim() ,jtflCorreo.getText().trim(),jtflGenero.getText().trim(),cn);
}else{
    controlador.Actualizar(Integer.parseInt(jtflcodigo.getText().trim()),Integer.parseInt(jtflNIT.getText().trim()),jtflNombre.getText().trim() ,jtflCorreo.getText().trim(),jtflGenero.getText().trim(),cn);
}

VistaAdmin.BanderaTablaCliente=false;  
VistaAdmin.BanderaBotonCliente=true;
...
limpiar();
    ...
    public javax.swing.JTextField jtflNIT;
